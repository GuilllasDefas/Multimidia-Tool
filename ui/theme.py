...
def setup_modern_theme(root):
    ...
    # Labels
    style.configure(
        'TLabel', background=COLORS['bg_card'], font=('Segoe UI', 10)
    )
    style.configure(
        'Bold.TLabel',
        background=COLORS['bg_card'],
    ...
    # Radiobutton
    style.configure(
        'TRadiobutton', background=COLORS['bg_card'], font=('Segoe UI', 10)
    )
    style.map(
        'TRadiobutton',
    ...
    # Checkbutton
    style.configure(
        'TCheckbutton', background=COLORS['bg_card'], font=('Segoe UI', 10)
    )
    style.map(
        'TCheckbutton',
        background=[('active', COLORS['bg_card'])],
